...
def _complete_systems_list(systems_list, start, end):
...
def _create_system_list(system_names_list):
...
def _compute_route(system_names_list, start_name, end_name):
    system_list = _create_system_list(system_names_list)
...
_complete_systems_list(system_names_list, start_system_name, end_system_name)
